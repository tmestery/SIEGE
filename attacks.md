...
**What it is:** Attempts to extract sensitive information from the model's context window, including system prompts, injected documents, prior conversation turns, or memorized training data.
